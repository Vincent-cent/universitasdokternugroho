...
return new class extends Migration
{
    ...
    public function up()
{
    Schema::create('collaborator_program', function (Blueprint $table) {
        $table->id();
        ...
        // Avoid duplicates
        $table->unique(['program_id','collaborator_id'], 'program_collab_unique');
    });
}
    ...
    {
        Schema::dropIfExists('program_collaborator');
    }
};
